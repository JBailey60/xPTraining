...
public class DefaultGetPlayerGameRecordsUseCaseTest {
    ...
    public void setup() {
        ...
        defaultCreateGameResultUseCase.execute(new CreateGameResultUseCase.Request(player2, player1, Throw.ROCK, Throw.PAPER, "THIS DATE"));
        defaultCreateGameResultUseCase.execute(new CreateGameResultUseCase.Request(player1, player3, Throw.SCISSORS, Throw.PAPER, "THIS DATE"));

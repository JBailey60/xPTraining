...
public abstract class GameResultRepositoryTest {
    ...
    public void canGetResults(){
        ...
        GameResult gameResult = new GameResult(player1, player2, Outcome.P1_WINS, Throw.ROCK, Throw.PAPER, 1,  "THIS DATE");
    ...
    public void canGetResultsById(){
        ...
        playerRepository.save( player2 );
        GameResult gameResult = new GameResult(player1, player2, Outcome.P1_WINS, Throw.PAPER, Throw.ROCK, 1,"THIS DATE" );
        gameResultRepository.save( gameResult );
        gameResult = new GameResult(player1, player2, Outcome.P2_WINS, Throw.PAPER, Throw.SCISSORS, 2,"THIS DATE" );
        gameResultRepository.save( gameResult );
